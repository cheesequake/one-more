        ...
        <AnimatePresence>
            ...
            className="w-11/12 h-15/16 flex flex-col justify-start items-center border-l border-l-white border-r border-r-white backdrop-blur-lg content bg-slate-100 bg-opacity-25 overflow-y-scroll">
                ...
                <div className="p-2 text-white">
                    ...
                    Currently, it leverages the combined power of Anthropic Claude 3.5 Sonnet v2 for SQL generation, and Llama 3.1 Instruct for natural language processing. Due to the abstraction from Bedrock, we can try out various models too. To know more about the code and the structure, please visit this private repository (<a href="https://github.com/cheesequake/one-more" className="font-medium">here</a>).<br /><br />
                    This application has been built on VCT Champions 2023 theme, with Patch 7.02 Homescreen, also inspired from the music video of <a href="https://www.youtube.com/watch?v=CdZN8PI3MqM" className="font-medium">Ticking Away ft. Grabbitz & bbno$</a>. The music video narrates a story of a young boy aspiring to be a professional Valorant player, finally achieving his dream at the end. This video has been a huge source of inspiration for me, and my favourite player Demon1 winning Champions 2023 further solidified my love for Valorant and gave me a motivation to be the best at what I do. Hoping some other player gets to live the same story!
                </div>
            </motion.div>
        </AnimatePresence>
    )
